...
const char* default_mqtt_server = "192.168.1.162";
const char* default_mqtt_port = "1883";
const char* device_id = "MEO1";
...
const int DHTPIN = 5;       //Đọc dữ liệu từ DHT11 ở chân A0 trên ESP
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  for (int i = 0; i < 10 ; i++)
  {
    ...
    else if (A[i][0] == 1)
    {
      switch (i)
      {
        case 0: analogWrite(0, A[i][1]); break;
        case 1: analogWrite(1, A[i][1]); break;
        case 2: analogWrite(2, A[i][1]); break;
        case 3: analogWrite(3, A[i][1]); break;
